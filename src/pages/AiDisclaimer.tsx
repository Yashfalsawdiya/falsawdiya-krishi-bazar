    ...
    <div className="space-y-6 pb-8">
      ...
      >
        ...
        <p className="text-xs text-gray-700 leading-relaxed font-normal whitespace-pre-line">
          {disclaimerData.introText}
        </p>

        {disclaimerData.emergencyNotice && (
          <div className="p-3.5 bg-rose-50 rounded-2xl border border-rose-200 text-xs text-rose-900 font-semibold flex items-start gap-2.5">
            <AlertTriangle className="w-4 h-4 text-rose-600 shrink-0 mt-0.5" />
            <span className="leading-relaxed">{disclaimerData.emergencyNotice}</span>
          </div>
        )}
      </motion.div>

      {/* Dynamic Sections */}
      {disclaimerData.sections && disclaimerData.sections.length > 0 && (
